...
class Zodiac(models.Model):
    name_th = models.CharField(max_length=30, blank=True)
...
class stone(models.Model):
    ...
    dis_description = models.TextField(null=True, blank=True)
    ...
    notusewith = ArrayField(models.IntegerField(), default=list, null=True, blank=True)
    zodiac = models.ForeignKey(Zodiac, on_delete=models.CASCADE, blank=True, null=True)
...
class BraceletPattern(models.Model):
    user_id = models.ForeignKey(FaceBookUserProfile, on_delete=models.CASCADE)
    name_pattern = models.TextField(null=True, blank=True)
    NumOfStones = models.IntegerField(blank=True, null=True)
    wristSize = models.IntegerField(blank=True, null=True)
    stoneSize = models.IntegerField(blank=True, null=True)
    stoneList = ArrayField(models.IntegerField(), default=list, null=True, blank=True)